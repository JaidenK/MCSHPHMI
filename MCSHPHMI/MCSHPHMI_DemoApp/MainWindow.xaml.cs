...
using static MCSHPHMI.Core.FileLoader;
using static MCSHPHMI.Core.Globals;
using static MCSHPHMI.Core.SwappableGeometry;
...
namespace MCSHPHMI_DemoApp
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            LoadAllSwappableGeometries("geometries.txt");
